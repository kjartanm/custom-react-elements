$(function () {
    ...
    var TodoView = Backbone.View.extend({
        ...
        initialize: function () {
            this.$el.addClass("mdc-data-table__row");
    ...
    var AppView = Backbone.View.extend({
        ...
        events: {
            ...
            "click .foo-button": "createOnClick",
        ...
        initialize: function () {
            ...
            this.allCheckbox = document.getElementById("toggle-all");

            this.listenTo(Todos, 'add', this.addOne);
            this.listenTo(Todos, 'reset', this.addAll);
            this.listenTo(Todos, 'all', this.render);
            this.listenTo(Todos, 'remove', model => {model.destroy()});
        ...
        addAll: function () {
            ...
            Todos.each(todo=>{ this.addOne(todo)});
        },
