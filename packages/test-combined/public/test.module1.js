(function (React, ReactDOM, contextProxy, redux, testStore, TestTheme) {
  'use strict';

  var React__default = 'default' in React ? React['default'] : React;
  var ReactDOM__default = 'default' in ReactDOM ? ReactDOM['default'] : ReactDOM;
  testStore = testStore && testStore.hasOwnProperty('default') ? testStore['default'] : testStore;
  TestTheme = TestTheme && TestTheme.hasOwnProperty('default') ? TestTheme['default'] : TestTheme;
  ...
  */
  ...
  var useEnhancedEffect$1 = typeof window !== 'undefined' && 'production' !== 'test' ? React__default.useLayoutEffect : React__default.useEffect;
  /**
  ...
  var IconButton$1 = withStyles$1(styles$2, {
    name: 'MuiIconButton'
  })(IconButton);
  ...
  var SwitchBase$1 = withStyles$1(styles$3, {
  ...
  var SvgIcon$1 = withStyles$1(styles$4, {
    name: 'MuiSvgIcon'
  })(SvgIcon);
  ...
  var Checkbox$1 = withStyles$1(styles$5, {
    name: 'MuiCheckbox'
  })(Checkbox);
  ...
  var Module1 = function Module1(_ref) {
    var children = _ref.children;

    var _useContext = useContext(contextProxy.TestContext),
        testProp = _useContext.testProp,
        setTestProp = _useContext.setTestProp;

    var _useState = useState('static player'),
        _useState2 = _slicedToArray(_useState, 2),
        playerName = _useState2[0],
        setCtxPlayerName = _useState2[1];

    var addressee = useSelector(function (state) {
      return state;
    });
    ...
    return React__default.createElement(React__default.Fragment, null, React__default.createElement("h2", {
      style: {
        color: 'black'
      }
    }, "Hello from Module#1, #", testProp, "#, #", playerName, "#, #", addressee, "# !"), React__default.createElement("button", {
      onClick: handleClick
    }, "Click"), React__default.createElement(Checkbox$1, null), children);
  };
  ...
  var App = function App(_ref2) {
    ...
    return React__default.createElement(Provider, {
      ...
      theme: TestTheme
    }, React__default.createElement(contextProxy.TestProvider, null, React__default.createElement(Module1, null, children))));
  };

  var Module1Rendrer = (function (el) {
    ReactDOM__default.render(App({
      children: el.children
    }), el);
    return null;
  });

  var ReactModule1Component =
  /*#__PURE__*/
  function (_HTMLElement) {
    _inherits(ReactModule1Component, _HTMLElement);

    function ReactModule1Component() {
      _classCallCheck(this, ReactModule1Component);

      return _possibleConstructorReturn(this, _getPrototypeOf(ReactModule1Component).apply(this, arguments));
    }

    _createClass(ReactModule1Component, [{
    ...
    return ReactModule1Component;
  }(_wrapNativeSuper(HTMLElement));

  customElements.define('react-test-module1', ReactModule1Component);

}(React, ReactDOM, ContextProxy, Redux, testStore, TestTheme));
